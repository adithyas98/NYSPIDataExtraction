...
directory = r'/Users/gaoyifan/Desktop/Javittlab/EC/DynEmo'
headerf = 'dye801.csv' #define the csv file to extract header
output = []
...
for filename in os.listdir(directory):
    if filename.endswith('.csv'):
        with open(filename,'r') as infile, open ('dye_merge.csv','w') as outfile: #open the file
            print(filename)
            line = infile.readline() #first line
