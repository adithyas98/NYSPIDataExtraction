...
filename = 'c2s410.txt' #define .txt file name
record_id = '33' #enter redcap ID here
...
data = []
with open(filename,'r') as infile, open ('c2s410.csv','w') as outfile: #open the file
