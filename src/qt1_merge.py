...
directory = r'/Users/gaoyifan/Desktop/Javittlab/EC/quickIQ/qt1'
headerf = 'qt1006.csv' #define the csv file to extract header
output = []
...
for filename in os.listdir(directory):
    if filename.endswith('.csv'):
        with open(filename,'r') as infile, open ('qt1_merge.csv','w') as outfile: #open the file
            print(filename)
            line = infile.readline() #first line
